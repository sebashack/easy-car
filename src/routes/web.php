...
// Publish request
Route::get('/publish-requests', 'App\Http\Controllers\PublishRequestController@index')->name('publishRequest.index');

Route::get('/publish-requests/create', 'App\Http\Controllers\PublishRequestController@create')->name('publishRequest.create');

Route::get('/publish-requests/{id}', 'App\Http\Controllers\PublishRequestController@show')->name('publishRequest.show');

Route::post('/publish-requests/save', 'App\Http\Controllers\PublishRequestController@save')->name('publishRequest.save');

Route::delete('/publish-requests/delete/{id}', 'App\Http\Controllers\PublishRequestController@delete')->name('publishRequest.delete');
